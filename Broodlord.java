...
*/
public class Broodlord extends AirFighter
{
	String name;
	double health;
	double attack;
	...
	public Broodlord()
	{
		this.cost = FC.BROODLORD_COST;
		this.health = 100;
		this.attack = FC.BROODLORD_ATTACK;
		this.armor = FC.BROODLORD_ARMOR;
		this.speed = FC.BROODLORD_SPEED;
	}
	...
	public String toString(){return "Broodlord";}	

	@Override 
	public boolean canAttack (Fighter target) {
        // we can only attack ground air targets
