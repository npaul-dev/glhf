public class VoidRay extends AirFighter
{
	...
	public VoidRay()
	{
		this.cost = FC.VOIDRAY_COST;
		this.health = 100;
		this.attack = FC.VOIDRAY_ATTACK;
		this.armor = FC.VOIDRAY_ARMOR;
		this.speed = FC.VOIDRAY_SPEED;
	...
	public String toString(){return "Void Ray";}	
