public class Reaper extends GroundFighter
{
	String name;
	double health;
	double attack;
	...
	public Reaper()
	{
		this.cost = FC.REAPER_COST;
		this.health = 100;
		this.attack = FC.REAPER_ATTACK;
		this.armor = FC.REAPER_ARMOR;
		this.speed = FC.REAPER_SPEED;
	}
	...
	public String toString(){return "Reaper";}
