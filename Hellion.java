public class Hellion extends GroundFighter
{
	String name;
	double health;
	double attack;
	...
	public Hellion()
	{
		this.cost = FC.HELLION_COST;
		this.health = 100;
		this.attack = FC.HELLION_ATTACK;
		this.armor = FC.HELLION_ARMOR;
		this.speed = FC.HELLION_SPEED;
	}
	...
	public String toString(){return "Hellion";}
