public class Marauder extends GroundFighter
{
	String name;
	double health;
	double attack;
	...
	public Marauder()
	{
		this.cost = FC.MARAUDER_COST;
		this.health = 100;
		this.attack = FC.MARAUDER_ATTACK;
		this.armor = FC.MARAUDER_ARMOR;
		this.speed = FC.MARAUDER_SPEED;
	}
	...
	public String toString(){return "Marauder";}
