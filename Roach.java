...
*/
public class Roach extends GroundFighter
{
	String name;
	double health;
	double attack;
	...
	public Roach()
	{
		this.cost = FC.ROACH_COST;
		this.health = 100;
		this.attack = FC.ROACH_ATTACK;
		this.armor = FC.ROACH_ARMOR;
		this.speed = FC.ROACH_SPEED;
	}
	...
	public String toString(){return "Roach";}	
